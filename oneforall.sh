...
trojan='bash <(curl -fsSL  https://raw.githubusercontent.com/muchovip/oneforall/main/trojan-go.sh)'
xray_grpc='bash <(curl -fsSL  https://raw.githubusercontent.com/muchovip/oneforall/main/xray_grpc.sh)'
v2ray='bash <(curl -fsSL  https://raw.githubusercontent.com/muchovip/oneforall/main/v2ray.sh)'
tuic='bash <(curl -fsSL  https://raw.githubusercontent.com/muchovip/oneforall/main/tuic.sh)'
...
xray='bash <(curl -fsSL  https://raw.githubusercontent.com/muchovip/oneforall/main/xray.sh )'
xtls_http='bash <(curl -fsSL  https://raw.githubusercontent.com/muchovip/oneforall/main/xtls_http.sh ) '
